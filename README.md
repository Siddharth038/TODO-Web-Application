...
Todo Web Application with Spring Security

This repository contains a feature-rich todo web application developed using the Java Spring framework, showcasing proficiency in Spring MVC, Spring Boot, Spring Data JPA, and Spring Security. The application includes secure authentication with two sets of credentials:
...
Setup Instructions
To run the todo web application locally, follow these steps:
